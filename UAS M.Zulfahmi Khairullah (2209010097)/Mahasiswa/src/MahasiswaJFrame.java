...
public class MahasiswaJFrame extends javax.swing.JFrame {
    ...
    Connection zulfahmi = koneksi.KoneksiDatabase.BukaKoneksi(); //fungsi untuk melakukan koneksi ke database mysql
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            ...
            if ("Simpan".equals(btnsimpan.getText())) {
                ...
                String Update = "UPDATE tbl_mahasiswa SET nama ='" + txtnamamahasiswa.getText() +
